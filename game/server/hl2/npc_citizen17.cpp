...
// Scared
constexpr citizen_expression_list_t ScaredExpressions[STATES_WITH_EXPRESSIONS] =
{
...
// Normal
constexpr citizen_expression_list_t NormalExpressions[STATES_WITH_EXPRESSIONS] =
{
...
// Angry
constexpr citizen_expression_list_t AngryExpressions[STATES_WITH_EXPRESSIONS] =
{
...
//-----------------------------------------------------------------------------
bool CNPC_Citizen::SpeakCommandResponse( AIConcept_t conceptual, const char *modifiers )
{
	return SpeakIfAllowed( conceptual,
